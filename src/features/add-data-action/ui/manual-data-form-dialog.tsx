...
import {
  AddDataCompletePanel,
  AddDataLoadingOverlay,
} from "./add-data-processing-overlay";
...
const ManualDataFormBody = ({ onSaveProceed }: ManualDataFormBodyProps) => {
  ...
  const updateRow = useCallback(
    (id: string, patch: Partial<Omit<ManualRow, "id">>) => {
      setRows((prev) =>
            ...
            >
              ...
              <div className={cn(manualFormRowFieldClass, "py-2")}>
                ...
                >
                  ...
                  >
                    <SelectValue
                      placeholder={t("addData.manualForm.category")}
                    />
                  </SelectTrigger>
                  <SelectContent>
...
export const ManualDataFormDialog = ({
  open,
  onOpenChange,
}: ManualDataFormDialogProps) => {
  const { t } = useTranslation("home");
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        {showComplete ? (
          ...
          <ManualDataFormBody
            key={formVersion}
            onSaveProceed={handleSaveProceed}
          />
        )}
      </DialogContent>
    </Dialog>
